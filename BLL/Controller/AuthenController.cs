...
namespace BLL.Controller
{
    ...
    public class AuthenController : OverallController
    {
        ...
        public  IActionResult Login([FromForm]LoginViewModel model)
        {
            ...
            {
                Response.Cookies.Append("AccessToken", token, option);
            }
            
            Response.Cookies.Append("Remember", model.Remember.ToString(), option);
            
            return Ok(new APIResult { Status = 1, Data = null, Message = "Đăng nhập thành công" });
        }
